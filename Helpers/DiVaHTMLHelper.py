...
# This one is dedicated to DiVA site.
# naprawić article name i authors name
...
class DiVaHTMLHelper:
    ...
    def get_article_name_value(self):
        articles_names = []
        for article_name in self.soup.find_all('div', class_="titleLink singleRow linkcolor"):
    ...
    def get_href_value(self):
        ...
        for href in self.soup.find_all('a', class_="titleLink singleRow linkcolor"):
            href_value.append("http://www.diva-portal.org{}".format(href.get("href")))
